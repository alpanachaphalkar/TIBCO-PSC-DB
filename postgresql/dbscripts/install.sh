...
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/ddl/create_PK.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/seed/ENTERPRISE.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/seed/ORGANIZATION.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/seed/DOMAIN.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/seed/DOMAINENTRY.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/seed/RELEASE.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/seed/RESOURCEACCESS.sql
...
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/seed/SCREEN.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/seed/FUNCTION.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/seed/HTMLELEMENTID.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/seed/FUNC2IDMAP.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/seed/FUNC2SCREENMAP.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/seed/ROLE.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/seed/ROLE2FUNCMAP.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/seed/SUPPLIERSTATE.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/seed/WORKFLOWFORM.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/seed/MEMBER.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/seed/MEMBERSHIP.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/seed/OBJECTSEQUENCE.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/seed/ROLEASSIGNMENT.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/seed/DOMAINLINK.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/seed/DOMAINVALUE.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/seed/ATTRIBUTEGROUP.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/seed/CATALOGFORMAT.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/seed/CATALOGTYPE.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/seed/CATALOGTYPEATTRIBUTE.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/seed/CATALOG.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/seed/CATALOGATTRIBUTE.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/seed/RELATIONSHIP.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/seed/PROCESSSELECTION.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/seed/HIVALUE.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/ddl/create_indexes.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/ddl/create_FK.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/ddl/create_views.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/ddl/create_functions.sql
"${PGSQL}" -U "${PGUSER}" -d "${PGDATABASE}" -ef ./mdm/install/scripts/triggers/create_triggers.sql
